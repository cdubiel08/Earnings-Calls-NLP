...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    function visualize(data) {
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            inputDiv.setAttribute("style", "width: 1000px"); // to match the width of the main svg element
            document.getElementById(visID).appendChild(inputDiv);

            // topic input container:
            var topicDiv = document.createElement("div");
            topicDiv.setAttribute("style", "padding: 1px; background-color: #e8e8e8; display: inline-block; width: " + mdswidth + "px; height: 50px; float: left");
            ...
            lambdaDiv.setAttribute("style", "padding: 1px; background-color: #e8e8e8; display: inline-block; height: 50px; width: " + lambdaDivWidth + "px; float: right; margin-right: 30px");
            inputDiv.appendChild(lambdaDiv);

            var lambdaZero = document.createElement("div");
            lambdaZero.setAttribute("style", "padding: 1px; height: 20px; width: 200px; font-family: sans-serif; float: left");
            ...
            sliderDiv.setAttribute("style", "padding: 1px; height: 50px; width: 220px; float: right; margin-top: -5px; margin-right: 1px");
            lambdaDiv.appendChild(sliderDiv);

            var lambdaInput = document.createElement("input");
            lambdaInput.setAttribute("style", "width: 220px; margin-left: 0px; margin-right: 0px");
